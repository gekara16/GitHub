...
namespace Monte_Carlo_Sim
{
 public class European: option
    {//constructor for european option class that is inherited from constructor of option class.
        public European (double So, double k, double r, double T, int steps, double sigma, int trials, bool y, bool x, bool multithread,double barrier,double rebate) : base( So, k,  T, r, sigma, y, trials, steps, x,multithread,barrier,rebate)
  ...
  _multithread = multithread;
        ...
        public double Get_price(double So, double k, double T, double r, double sigma, int trials, int steps, bool call, bool x, bool y,bool multithread,double[,] randn,  out double SE)
        {
            ...
            simulator euro = new simulator();

            double[,] St = euro.simulate(So, k, T, r, sigma, trials, x,multithread, steps, randn);
