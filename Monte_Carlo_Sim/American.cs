...
namespace Monte_Carlo_Sim
{
    ...
    { //constructor for American option class that is inherited from constructor of option class.
        public American (double So, double k, double r, double T, int steps, double sigma, int trials, bool y, bool x, bool multithread,double barrier,double rebate) : base( So, k,  T, r, sigma, y, trials, steps, x,multithread,barrier,rebate)
        ...
        public double Get_price(double So, double k, double T, double r, double sigma, int trials, int steps, bool call, bool x, bool y, bool multithread, double[,] randn, out double SE)
        {
            ...
            double call_delta = d1.Blackscholes_delta(So, k, T, r, sigma);
            double put_delta = d1.Blackscholes_delta(So, k, T, r, sigma) - 1;
            ...
            Price = (sumoption / Convert.ToDouble(trials)) * Math.Exp(-r * T);//option price
